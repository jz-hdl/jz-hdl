---
url: /jz-hdl/reference-manual/formal-reference/memory.md
---
...
When `addr_r != addr_w`, all modes behave identically (return stored word at addr\_r).
...
* Result width must be <= word\_width; overflow is a compile error.
...
| --- | --- | --- | --- |
| Storage | Single value (N bits) | None (combinational) | Array (word\_width x depth) |
