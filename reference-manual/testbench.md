---
url: /jz-hdl/reference-manual/testbench.md
---
...
Reset values are applied **only** when the RESET signal meets the RESET\_ACTIVE condition. Before reset is asserted, reading uninitialized storage yields random bits — exactly as in real hardware.
