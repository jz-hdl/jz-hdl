...
| WARN_INCOMPLETE_SELECT_ASYNC | warning | S5.4/S8.3 Incomplete SELECT coverage without DEFAULT in ASYNCHRONOUS block | 12_3_WARN_INCOMPLETE_SELECT_ASYNC-incomplete_select.jz |
