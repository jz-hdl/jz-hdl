# JZ-HDL Compiler Rule Coverage Map

**Total rules in `compiler/src/rules.c`:** 387
...
**Status definitions:**
- **Tested** — rule appears in the named test plan's `5.1 Rules Tested` section.
- **Not Tested** — rule is not yet covered in any plan's `5.1`. Mapped to the closest plan by primary spec section (S<x.y>).
- **Not Testable: `<reason>`** — rule cannot be reached via `compiler/build/jz-hdl --info --lint <file>.jz` (e.g., backend file write, simulation runtime).

`compiler/tests/issues.md` does not exist, so no rules are classified Bug/Unimplemented/Dead code/Suppressed in this pass.
...
| DIRECTIVE_INVALID_CONTEXT | test_1_1-identifiers.md,test_4_1-module_canonical_form.md,test_9_3-check_placement_rules.md,test_9_7-check_error_conditions.md | Tested |
| KEYWORD_AS_IDENTIFIER | test_1_1-identifiers.md | Tested |
| IF_COND_MISSING_PARENS | test_5_3-conditional_statements.md | Tested |
| INSTANCE_UNDEFINED_MODULE | test_4_13-module_instantiation.md,test_6_9-top_level_module.md | Tested |
...
| TYPE_BINOP_WIDTH_MISMATCH | test_2_2-signedness_model.md,test_2_3-bit_width_constraints.md,test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| WIDTH_NONPOSITIVE_OR_NONINT | test_2_2-signedness_model.md,test_2_3-bit_width_constraints.md | Tested |
| WIDTH_ASSIGN_MISMATCH_NO_EXT | test_2_3-bit_width_constraints.md,test_4_10-asynchronous_block.md | Tested |
...
| UNARY_ARITH_MISSING_PARENS | test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| LOGICAL_WIDTH_NOT_1 | test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| TERNARY_COND_WIDTH_NOT_1 | test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| TERNARY_BRANCH_WIDTH_MISMATCH | test_2_3-bit_width_constraints.md,test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| CONCAT_EMPTY | test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| DIV_CONST_ZERO | test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| DIV_UNGUARDED_RUNTIME_ZERO | test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| SPECIAL_DRIVER_IN_EXPRESSION | test_2_4-special_semantic_drivers.md,test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| SPECIAL_DRIVER_IN_CONCAT | test_2_4-special_semantic_drivers.md,test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| SPECIAL_DRIVER_SLICED | test_1_3-bit_slicing_and_indexing.md,test_2_4-special_semantic_drivers.md,test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| SPECIAL_DRIVER_IN_INDEX | test_2_4-special_semantic_drivers.md,test_3_1-operator_categories.md,test_3_2-operator_definitions.md,test_3_4-operator_examples.md | Tested |
| SBIT_SET_WIDTH_NOT_1 | test_5_5-intrinsic_operators.md | Tested |
| GBIT_INDEX_OUT_OF_RANGE | test_5_5-intrinsic_operators.md | Tested |
| SBIT_INDEX_OUT_OF_RANGE | test_5_5-intrinsic_operators.md | Tested |
| GSLICE_INDEX_OUT_OF_RANGE | test_5_5-intrinsic_operators.md | Tested |
| GSLICE_WIDTH_INVALID | test_5_5-intrinsic_operators.md | Tested |
| SSLICE_INDEX_OUT_OF_RANGE | test_5_5-intrinsic_operators.md | Tested |
...
| MODULE_NAME_DUP_IN_PROJECT | test_4_2-scope_and_uniqueness.md,test_6_10-project_scope_and_uniqueness.md | Tested |
...
| CONST_CIRCULAR_DEP | test_4_3-const.md,test_7_10-const_evaluation_in_mem.md | Tested |
...
| WIRE_MULTI_DIMENSIONAL | test_4_5-wire.md | Tested |
| REG_MULTI_DIMENSIONAL | test_4_7-register.md | Tested |
| REG_MISSING_INIT_LITERAL | test_4_7-register.md | Tested |
...
| WRITE_WIRE_IN_SYNC | test_4_11-synchronous_block.md,test_4_5-wire.md,test_5_2-synchronous_assignments.md | Tested |
| ASSIGN_TO_NON_REGISTER_IN_SYNC | test_4_11-synchronous_block.md,test_5_2-synchronous_assignments.md | Tested |
...
| LATCH_WIDTH_INVALID | test_4_8-latches.md | Tested |
| LATCH_SR_WIDTH_MISMATCH | test_4_8-latches.md | Tested |
| LATCH_AS_CLOCK_OR_CDC | test_4_8-latches.md | Tested |
| LATCH_IN_CONST_CONTEXT | test_4_8-latches.md | Tested |
...
| INSTANCE_ARRAY_MULTI_DIMENSIONAL | test_4_13-module_instantiation.md | Tested |
| INSTANCE_INTERNAL_ACCESS | test_4_13-module_instantiation.md | Tested |
...
| ASSIGN_WIDTH_NO_MODIFIER | test_2_3-bit_width_constraints.md,test_5_0-assignment_operators_summary.md,test_8_4-global_value_semantics.md | Tested |
...
| ASSIGN_CONCAT_WIDTH_MISMATCH | test_2_3-bit_width_constraints.md,test_5_0-assignment_operators_summary.md | Tested |
| ASSIGN_MULTIPLE_SAME_BITS | test_10_6-template_exclusive_assignment.md,test_10_8-template_error_cases.md,test_1_5-exclusive_assignment_rule.md,test_5_0-assignment_operators_summary.md | Tested |
| ASSIGN_INDEPENDENT_IF_SELECT | test_1_5-exclusive_assignment_rule.md,test_5_0-assignment_operators_summary.md | Tested |
| ASSIGN_SHADOWING | test_1_5-exclusive_assignment_rule.md,test_5_0-assignment_operators_summary.md | Tested |
| ASSIGN_SLICE_OVERLAP | test_1_5-exclusive_assignment_rule.md,test_5_0-assignment_operators_summary.md | Tested |
| ASYNC_UNDEFINED_PATH_NO_DRIVER | test_1_5-exclusive_assignment_rule.md,test_4_10-asynchronous_block.md,test_5_1-asynchronous_assignments.md | Tested |
| ASYNC_INVALID_STATEMENT_TARGET | test_4_10-asynchronous_block.md,test_5_1-asynchronous_assignments.md | Tested |
| ASYNC_ASSIGN_REGISTER | test_4_10-asynchronous_block.md,test_4_7-register.md,test_5_1-asynchronous_assignments.md | Tested |
| ASYNC_ALIAS_LITERAL_RHS | test_4_10-asynchronous_block.md,test_5_1-asynchronous_assignments.md | Tested |
| SYNC_MULTI_ASSIGN_SAME_REG_BITS | test_10_6-template_exclusive_assignment.md,test_10_8-template_error_cases.md,test_5_2-synchronous_assignments.md | Tested |
| SYNC_ROOT_AND_CONDITIONAL_ASSIGN | test_5_2-synchronous_assignments.md | Tested |
| SYNC_SLICE_WIDTH_MISMATCH | test_5_2-synchronous_assignments.md | Tested |
...
| DUPLICATE_BLOCK | test_4_1-module_canonical_form.md,test_4_11-synchronous_block.md | Tested |
...
| CDC_SOURCE_NOT_PLAIN_REG | test_4_12-cdc_block.md | Tested |
| CDC_DEST_ALIAS_ASSIGNED | test_4_12-cdc_block.md | Tested |
...
| ASYNC_ALIAS_IN_CONDITIONAL | test_4_10-asynchronous_block.md,test_5_3-conditional_statements.md | Tested |
...
| CLOG2_NONPOSITIVE_ARG | test_5_5-intrinsic_operators.md | Tested |
| CLOG2_INVALID_CONTEXT | test_5_5-intrinsic_operators.md | Tested |
| WIDTHOF_INVALID_CONTEXT | test_5_5-intrinsic_operators.md | Tested |
...
| FUNC_RESULT_TRUNCATED_SILENTLY | test_5_5-intrinsic_operators.md | Tested |
| WIDTHOF_INVALID_TARGET | test_5_5-intrinsic_operators.md | Tested |
| WIDTHOF_INVALID_SYNTAX | test_5_5-intrinsic_operators.md | Tested |
| WIDTHOF_WIDTH_NOT_RESOLVABLE | test_5_5-intrinsic_operators.md | Tested |
| NET_FLOATING_WITH_SINK | test_1_2-fundamental_terms.md,test_1_6-high_impedance_and_tristate.md | Tested |
| NET_TRI_STATE_ALL_Z_READ | test_11_3-tristate_net_identification.md,test_1_2-fundamental_terms.md,test_1_6-high_impedance_and_tristate.md | Tested |
| NET_MULTIPLE_ACTIVE_DRIVERS | test_11_3-tristate_net_identification.md,test_1_2-fundamental_terms.md,test_1_6-high_impedance_and_tristate.md | Tested |
| NET_DANGLING_UNUSED | test_1_2-fundamental_terms.md,test_1_6-high_impedance_and_tristate.md | Tested |
| OBS_X_TO_OBSERVABLE_SINK | test_1_2-fundamental_terms.md,test_1_6-high_impedance_and_tristate.md,test_3_2-operator_definitions.md | Tested |
| COMB_LOOP_UNCONDITIONAL | test_12_2-combinational_loop_errors.md,test_1_2-fundamental_terms.md,test_1_6-high_impedance_and_tristate.md | Tested |
| COMB_LOOP_CONDITIONAL_SAFE | test_12_2-combinational_loop_errors.md,test_1_2-fundamental_terms.md,test_1_6-high_impedance_and_tristate.md | Tested |
| BUS_DEF_DUP_NAME | test_6_8-bus_aggregation.md | Tested |
| BUS_DEF_SIGNAL_DUP_NAME | test_6_8-bus_aggregation.md | Tested |
| BUS_DEF_INVALID_DIR | test_6_8-bus_aggregation.md | Tested |
...
| PROJECT_MULTIPLE_PER_FILE | test_6_10-project_scope_and_uniqueness.md,test_6_2-project_canonical_form.md | Tested |
...
| PROJECT_CHIP_DATA_VARIANT_INVALID | test_9_3-check_placement_rules.md | Tested |
...
| CONFIG_MULTIPLE_BLOCKS | test_6_3-config_block.md | Tested |
...
| CHECK_FAILED | test_9_2-check_semantics.md,test_9_7-check_error_conditions.md | Tested |
| CHECK_INVALID_EXPR_TYPE | test_9_1-check_syntax.md,test_9_4-check_expression_rules.md,test_9_5-check_evaluation_order.md,test_9_7-check_error_conditions.md | Tested |
| CHECK_INVALID_PLACEMENT | test_9_3-check_placement_rules.md,test_9_7-check_error_conditions.md | Tested |
...
| GLOBAL_INVALID_EXPR_TYPE | test_8_2-global_syntax.md,test_8_5-global_errors.md | Tested |
...
| GLOBAL_ASSIGN_FORBIDDEN | test_8_1-global_purpose.md,test_8_5-global_errors.md | Tested |
...
| MAP_INVALID_BOARD_PIN_ID | test_6_6-map_block.md | Tested |
...
| PIN_WIDTH_REQUIRES_DIFFERENTIAL | test_6_5-pin_blocks.md | Tested |
...
| CLOCK_GEN_PAD_EXCLUSIVE_CONFLICT | test_6_4-clocks_block.md | Tested |
| CLOCK_GEN_INVALID_TYPE | test_6_4-clocks_block.md | Tested |
...
| CLOCK_GEN_VARIANT_NO_MATCH | test_9_3-check_placement_rules.md | Tested |
| CLOCK_GEN_VARIANT_AMBIGUOUS | test_9_3-check_placement_rules.md | Tested |
| BLACKBOX_BODY_DISALLOWED | test_6_7-blackbox_modules.md | Tested |
| BLACKBOX_UNDEFINED_IN_NEW | test_6_7-blackbox_modules.md | Tested |
...
| MEM_UNDEFINED_CONST_IN_WIDTH | test_7_1-mem_declaration.md,test_7_10-const_evaluation_in_mem.md | Tested |
...
| MEM_INVALID_PORT_TYPE | test_7_0-memory_port_modes.md,test_7_1-mem_declaration.md | Tested |
| MEM_MISSING_INIT | test_7_1-mem_declaration.md,test_7_5-initialization.md | Tested |
| MEM_INIT_FILE_NOT_FOUND | test_7_5-initialization.md | Tested |
| MEM_INIT_CONTAINS_X | test_7_5-initialization.md | Tested |
| MEM_INIT_FILE_CONTAINS_X | test_7_5-initialization.md | Tested |
| MEM_INIT_FILE_TOO_LARGE | test_7_5-initialization.md | Tested |
| MEM_TYPE_INVALID | test_4_9-mem_block.md,test_7_1-mem_declaration.md | Tested |
...
| MEM_INOUT_MIXED_WITH_IN_OUT | test_7_1-mem_declaration.md,test_7_2-port_types_and_semantics.md | Tested |
| MEM_INOUT_ASYNC | test_7_1-mem_declaration.md,test_7_2-port_types_and_semantics.md | Tested |
...
| MEM_SYNC_ADDR_IN_ASYNC_BLOCK | test_7_3-memory_access_syntax.md | Tested |
| MEM_SYNC_DATA_IN_ASYNC_BLOCK | test_7_3-memory_access_syntax.md | Tested |
| MEM_SYNC_ADDR_WITHOUT_RECEIVE | test_7_3-memory_access_syntax.md | Tested |
| MEM_READ_SYNC_WITH_EQUALS | test_7_3-memory_access_syntax.md | Tested |
...
| MEM_WRITE_TO_READ_PORT | test_7_2-port_types_and_semantics.md,test_7_3-memory_access_syntax.md | Tested |
| MEM_READ_FROM_WRITE_PORT | test_7_2-port_types_and_semantics.md,test_7_3-memory_access_syntax.md | Tested |
| MEM_ADDR_WIDTH_TOO_WIDE | test_7_3-memory_access_syntax.md | Tested |
| MEM_MULTIPLE_WRITES_SAME_IN | test_7_2-port_types_and_semantics.md,test_7_3-memory_access_syntax.md | Tested |
...
| MEM_INVALID_WRITE_MODE | test_7_0-memory_port_modes.md,test_7_3-memory_access_syntax.md,test_7_4-write_modes.md | Tested |
| MEM_INOUT_INDEXED | test_7_2-port_types_and_semantics.md,test_7_3-memory_access_syntax.md | Tested |
| MEM_INOUT_WDATA_IN_ASYNC | test_7_2-port_types_and_semantics.md,test_7_3-memory_access_syntax.md | Tested |
| MEM_INOUT_ADDR_IN_ASYNC | test_7_2-port_types_and_semantics.md,test_7_3-memory_access_syntax.md | Tested |
| MEM_INOUT_WDATA_WRONG_OP | test_7_3-memory_access_syntax.md | Tested |
| MEM_MULTIPLE_ADDR_ASSIGNS | test_7_3-memory_access_syntax.md | Tested |
| MEM_MULTIPLE_WDATA_ASSIGNS | test_7_3-memory_access_syntax.md | Tested |
| MEM_WARN_PORT_NEVER_ACCESSED | test_7_7-error_checking_and_validation.md | Tested |
| MEM_WARN_PARTIAL_INIT | test_7_5-initialization.md,test_7_7-error_checking_and_validation.md | Tested |
| MEM_WARN_DEAD_CODE_ACCESS | test_7_7-error_checking_and_validation.md | Tested |
| TRISTATE_TRANSFORM_MUTUAL_EXCLUSION_FAIL | test_11_4-tristate_transformation_algorithm.md,test_11_5-tristate_validation_rules.md,test_11_7-tristate_error_conditions.md | Tested |
| TRISTATE_TRANSFORM_PER_BIT_FAIL | test_11_4-tristate_transformation_algorithm.md,test_11_5-tristate_validation_rules.md,test_11_7-tristate_error_conditions.md | Tested |
| TRISTATE_TRANSFORM_BLACKBOX_PORT | test_11_6-tristate_inout_handling.md,test_11_7-tristate_error_conditions.md | Tested |
| TRISTATE_TRANSFORM_SINGLE_DRIVER | test_11_4-tristate_transformation_algorithm.md,test_11_7-tristate_error_conditions.md | Tested |
| TRISTATE_TRANSFORM_OE_EXTRACT_FAIL | test_11_6-tristate_inout_handling.md,test_11_7-tristate_error_conditions.md | Tested |
| TRISTATE_TRANSFORM_UNUSED_DEFAULT | test_11_1-tristate_default_purpose.md,test_11_7-tristate_error_conditions.md,test_11_8-tristate_portability.md | Tested |
| INFO_TRISTATE_TRANSFORM | test_11_1-tristate_default_purpose.md,test_11_4-tristate_transformation_algorithm.md,test_11_7-tristate_error_conditions.md | Tested |
| INFO_SERIALIZER_CASCADE | test_misc-repeat_serializer_io.md | Tested |
| SERIALIZER_WIDTH_EXCEEDS_RATIO | test_misc-repeat_serializer_io.md | Tested |
| TEMPLATE_UNDEFINED | test_10_5-template_application.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_ARG_COUNT_MISMATCH | test_10_5-template_application.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_COUNT_NOT_NONNEG_INT | test_10_5-template_application.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_NESTED_DEF | test_10_4-template_forbidden_content.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_FORBIDDEN_DECL | test_10_4-template_forbidden_content.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_FORBIDDEN_BLOCK_HEADER | test_10_4-template_forbidden_content.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_FORBIDDEN_DIRECTIVE | test_10_4-template_forbidden_content.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_SCRATCH_OUTSIDE | test_10_3-template_allowed_content.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_APPLY_OUTSIDE_BLOCK | test_10_5-template_application.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_DUP_NAME | test_10_2-template_definition.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_DUP_PARAM | test_10_2-template_definition.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_SCRATCH_WIDTH_INVALID | test_10_3-template_allowed_content.md,test_10_8-template_error_cases.md | Tested |
| TEMPLATE_EXTERNAL_REF | test_10_3-template_allowed_content.md,test_10_8-template_error_cases.md | Tested |
...
| SIM_RUN_COND_TIMEOUT | — | Not Testable: fires at simulation runtime, not at lint |
| RPT_COUNT_INVALID | test_misc-repeat_serializer_io.md | Tested |
| RPT_NO_MATCHING_END | test_misc-repeat_serializer_io.md | Tested |
| WARN_UNUSED_REGISTER | test_12_3-recommended_warnings.md,test_4_7-register.md | Tested |
| WARN_UNSINKED_REGISTER | test_12_3-recommended_warnings.md,test_4_7-register.md | Tested |
| WARN_UNDRIVEN_REGISTER | test_12_3-recommended_warnings.md,test_4_7-register.md | Tested |
| WARN_UNCONNECTED_OUTPUT | test_12_3-recommended_warnings.md | Tested |
| WARN_INCOMPLETE_SELECT_ASYNC | test_12_3-recommended_warnings.md | Tested |
...
| WARN_INTERNAL_TRISTATE | test_11_1-tristate_default_purpose.md,test_11_7-tristate_error_conditions.md,test_11_8-tristate_portability.md,test_12_3-recommended_warnings.md | Tested |
| IO_BACKEND | — | Not Testable: backend file write; not reachable via --lint |
| IO_IR | — | Not Testable: IR file write; not reachable via --lint |
| PATH_ABSOLUTE_FORBIDDEN | test_12_4-path_security.md | Tested |
| PATH_TRAVERSAL_FORBIDDEN | test_12_4-path_security.md | Tested |
| PATH_OUTSIDE_SANDBOX | test_12_4-path_security.md | Tested |
| PATH_SYMLINK_ESCAPE | test_12_4-path_security.md | Tested |
