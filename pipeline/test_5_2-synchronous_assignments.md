...
| SYNC_SLICE_WIDTH_MISMATCH | error | S5.2 Register slice assignment expression width not equal to slice width | 5_2_SYNC_SLICE_WIDTH_MISMATCH-slice_width_mismatch.jz |
