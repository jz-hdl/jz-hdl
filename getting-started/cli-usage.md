---
url: /jz-hdl/getting-started/cli-usage.md
---
...
| `--chip-info` | Print chip data for the given CHIP\_ID (or list all supported chips if no ID given). |
...
| `--version` | Print the compiler version and git commit (e.g., `Version 0.2.1 (abc1234)`). |
