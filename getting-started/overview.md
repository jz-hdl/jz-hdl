---
url: /jz-hdl/getting-started/overview.md
---
...
* Memory semantics
  ...
  * Write mode (WRITE\_FIRST / READ\_FIRST / NO\_CHANGE) determines read behavior when a read and write target the same address in one cycle.
